...
module.exports = function Setup() {
    console.log(cliColor.cyanBright("Welcome to CalagopusStats!"))
        ...
        if (index < questions.length) {
            ...
            readline.question('> ', answer => {
                ...
                if (index === Question.panelUrl && !isValidURL(answer)) {
                    ...
                    isValid = false;
                } else if (index === Question.panelApiKey && !answer.trim()) {
                    console.log(cliColor.redBright("❌ Invalid Panel API key. It cannot be empty."));
                    isValid = false;
            ...
            axios(`${new URL(answers[Question.panelUrl]).origin}/api/admin/nodes?page=1&per_page=1`, {
                method: "GET",
                headers: {
