...
console.log(cliColor.cyanBright("[CalagopusStats] ") + cliColor.yellow("Loading configuration..."));

let config = yaml.load(fs.readFileSync("./config.yml", "utf8"));
if (fs.existsSync("config-dev.yml")) {
    console.log(cliColor.cyanBright("[CalagopusStats] ") + cliColor.yellow("Using development configuration..."));
...
console.log(cliColor.cyanBright("[CalagopusStats] ") + cliColor.yellow("Configuration loaded"));
